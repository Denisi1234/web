            ...
            <div class="col-xl-8 col-lg-10 col-md-12">
                <div class="fpc-capstion text-center my-4">
                    <div class="fpc-captions">
                        <h1 class="xl-heading text-light font-bold">Customer Terms of Service</h1>
                        <p class="text-light opacity-90">Official Terms governing accommodation, experience, and transportation bookings across Tanzania.</p>
                    </div>
                </div>
            </div>
        </div>
