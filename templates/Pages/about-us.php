			...
			<div class="col-xl-8 col-lg-10 col-md-12">
				<div class="fpc-capstion text-center my-5">
					<div class="fpc-captions">
						...
						<p class="text-muted fs-5" style="color:#5f6368;font-family:Roboto,sans-serif;">Tanzania’s premier accommodation & travel booking marketplace connecting travelers with authentic lodges, beachfront resorts, and city stays.</p>
					</div>
				</div>
			</div>
		</div>
