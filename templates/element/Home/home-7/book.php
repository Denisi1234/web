<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
    <div class="navTabbs d-flex align-items-center justify-content-center w-100 mb-2">
        <ul class="nav nav-pills lights medium justify-content-center mb-3" id="tour-pills-tab" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" data-bs-toggle="tab" href="#hotels"><i class="bi bi-buildings me-2"></i>Hotels</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#flights"><i class="bi bi-airplane me-2"></i>Flights</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#tours"><i class="bi bi-globe2 me-2"></i>Tour</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#cabs"><i class="bi bi-car-front me-2"></i>Cab</a>
            </li>
        </ul>
    </div>
    <div class="search-wrap bg-transparents rounded-3 p-3">
        <div class="tab-content">
            <div class="tab-pane show active" id="hotels">
                <div class="row align-items-end gy-2 gx-md-2 gx-sm-2">

                    <div class="col-xl-8 col-lg-7 col-md-12">
                        <div class="row align-items-end gy-3 gx-md-2 gx-sm-2">
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    <div class="inputIicon">
                                        ...
                                        <div class="input-box autocomplete-container">
                                            <input class="form-control fw-medium fs-md flightInput" type="text" placeholder="Goint To">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <div class="form-group mb-0">
                                    ...
                                    <div class="inputIicon">
                                        ...
                                        <div class="input-box">
                                            <input class="form-control fw-medium fs-md" id="checkinout" type="text" placeholder="Choose Date" readonly="readonly">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-5 col-md-12">
                        <div class="row align-items-end gy-3 gx-md-2 gx-sm-2">
                                            ...
                                            <div class="input-box">
                                                <div class="selection-container">
                                                    <div class="traveler-box">
                                                        <input type="text" class="form-control fw-medium input-box fs-md traveler-input" value="1 Room, 1 Adult" readonly>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
                                <div class="form-group mb-0">
                                    <button type="button" class="btn btn-warning text-dark full-width fw-medium"><i class="fa-solid fa-magnifying-glass me-2"></i>Search</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="tab-pane" id="flights">
                <div class="search-upper">
                    <div class="d-flex align-items-center justify-content-between flex-wrap">
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            <label class="form-check-label text-light" for="return">Return</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="trip" id="oneway" value="option2">
                            <label class="form-check-label text-light" for="oneway">One Way</label>
                        </div>
                        </div>
                        ...
                        <div class="ps-1 pb-3 pt-0 mob-full">
                            ...
                            <div class="selections">
                                <span class="selected">Economy</span>
                                <div class="caret"></div>
                            </div>
                            <ul class="menu">
                ...
                <div class="row align-items-end gx-lg-2 g-3">

                    <div class="col-xl-6 col-lg-6 col-md-12">
                        <div class="row align-items-end gy-3 gx-lg-2 gx-3">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 position-relative">
                                <div class="form-group mb-0">
                                    ...
                                    <div class="inputIicon">
                                        ...
                                        <div class="input-box autocomplete-container">
                                            <input class="form-control fw-medium fs-md flightInput" type="text" placeholder="Leaving From">
                                            <div class="suggestions"></div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 position-relative">
                                <div class="form-group mb-0">
                                    ...
                                    <div class="inputIicon">
                                        ...
                                        <div class="input-box autocomplete-container">
                                            <input class="form-control fw-medium fs-md flightInput" type="text" placeholder="Going To">
                                            <div class="suggestions"></div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12">
                        <div class="row align-items-end gy-3 gx-lg-2 gx-3">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <div class="form-group mb-0">
                                    <label class="text-light text-uppercase opacity-75">Number of Travelers</label>
                                    <div class="inputIicon">
                                        <div class="myIcon">
                                            <svg width="24" height="24" viewBox="0 0 24 24" class="fill-primary" xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.3" d="M22 12C22 17.5 17.5 22 12 22C6.5 22 2 17.5 2 12C2 6.5 6.5 2 12 2C17.5 2 22 6.5 22 12ZM12 7C10.3 7 9 8.3 9 10C9 11.7 10.3 13 12 13C13.7 13 15 11.7 15 10C15 8.3 13.7 7 12 7Z"/>
                                        ...
                                        <div class="input-box">
                                            <div class="selection-container">
                                                <div class="traveler-box">
                                                    <input type="text" class="form-control fw-medium input-box fs-md traveler-input" value="1 Adult" readonly>
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-12">
                        <div class="form-group mb-0">
                        <button type="button" class="btn btn-warning text-dark full-width fw-medium"><i
                ...
                <div class="row gy-3 gx-md-2 gx-sm-2">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 position-relative">
                                <div class="form-group mb-0">
                                    ...
                                    <div class="inputIicon">
                                        ...
                                        <div class="input-box autocomplete-container">
                                            <input class="form-control fw-medium fs-6 flightInput" type="text" placeholder="Where to?">
                                            <div class="suggestions"></div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                <div class="form-group mb-0">
                                    ...
                                    <div class="inputIicon">
                                        ...
                                        <div class="input-box">
                                            <input class="form-control fw-medium fs-6 choosedate" type="text" placeholder="When ?" readonly="readonly">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-5 col-md-12">
                        <div class="row align-items-end gy-3 gx-md-2 gx-sm-2">
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
                                <div class="form-group mb-0">
                                    <label class="text-light text-uppercase opacity-75">Number of Guests</label>
                                    <div class="form-group mb-0">
                                        <div class="inputIicon">
                                            <div class="myIcon">
                                                <svg width="24" height="24" viewBox="0 0 24 24" class="fill-primary" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 position-relative">
                                <div class="form-group mb-0">
                                    ...
                                    <div class="inputIicon">
                                        ...
                                        <div class="input-box autocomplete-container">
                                            <input class="form-control fw-medium fs-md flightInput" type="text" placeholder="Pickup From">
                                            <div class="suggestions"></div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 position-relative">
                                <div class="form-group mb-0">
                                    ...
                                    <div class="inputIicon">
                                        ...
                                        <div class="input-box autocomplete-container">
                                            <input class="form-control fw-medium fs-md flightInput" type="text" placeholder="Drop To">
                                            <div class="suggestions"></div>
                                        </div>
                                    </div>
                                </div>
