...
<div class="position-relative bg-cover py-5 bg-primary" style="background:url(<?= $this->Url->build('/assets/img/bg.jpg'); ?>)no-repeat;" data-overlay="5">
    <div class="container">
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-xl-8 col-lg-9 col-md-10 col-sm-11 text-center">
                            ...
                            <div class="calltoAction-title mb-5">
                                <h4 class="text-light fs-2 fw-bold lh-base m-0">Subscribe & Get<br>Special Discount with fastnetstays.com </h4>
                            </div>
                                ...
                                <form>
                                    <div class="row align-items-center justify-content-between bg-white rounded-3 p-2 gx-0">
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-4">
                                            <div class="form-group m-0">
                                                <button type="button" class="btn btn-primary fw-medium full-width">Submit<i class="fa-solid fa-arrow-trend-up ms-2"></i></button>
                                            </div>
                                        </div>
