            ...
            <div class="modal-body p-5">
                <div class="verify-email-wrap mb-5">
                    <div class="icon-wrap text-center mb-4">
                        <img src="<?= $this->Url->build('/assets/img/check-mail.png'); ?>" class="img-fluid mx-auto" width="140" alt="Image">
                    </div>
                    
                    <div class="message-wrap text-center d-block mb-4">
                        <h4 class="mb-4">Verify your email address</h4>
                        <h6 class="fw-normal">You've entered support@shreethemes.in as the email address for your account.</h6>
                        <p>Please verify this email adress by clicking button bellow</p>
                    </div>
                    
                    <div class="button-wrap text-center">
                        <a href="JavaScript:Void(0);" class="btn btn-primary px-5">Verify your email</a>
                    </div>
                ...
                <div class="other-option text-center">
                    ...
                    <p class="m-0">
                        <a href="JavaScript:Void(0);" class="text-main">https://www.Email-Verification-Verifying-your-email-address-when-you-sign-up</a>
                    </p>
                </div>
            </div>
        </div>
