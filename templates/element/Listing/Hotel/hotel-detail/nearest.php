            ...
            <div class="row align-items-start">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12">
                    <ul class="row align-items-center p-0 mb-0">
                        ...
                        <li class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div class="explot-first">Metro:<span class="text-dark ms-2">Jalan Besar MRT</span></div>
                                <div class="explot-distance"><span class="text-muted">80m</span></div>
                            </div>
                        </li>
                        <li class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div class="explot-first">Airport:<span class="text-dark ms-2">Singapore Changi Airport</span></div>
                                <div class="explot-distance"><span class="text-muted">160m</span></div>
                            </div>
                        </li>
                        <li class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div class="explot-first">Train:<span class="text-dark ms-2">Woodlands Train Checkpoint</span></div>
            ...
            <div class="row align-items-start">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12">
                    <ul class="row align-items-center p-0 mb-0">
                        ...
                        <li class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div class="explot-first"><span class="text-dark ms-2">Tai Hwa Pork Noodle</span></div>
                                <div class="explot-distance"><span class="text-muted">80m</span></div>
                            </div>
                        </li>
                        <li class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        ...
                        <li class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div class="explot-first"><span class="text-dark ms-2">Taliwang Restaurant</span></div>
                                <div class="explot-distance"><span class="text-muted">200m</span></div>
                            </div>
                        </li>
                    </ul>
